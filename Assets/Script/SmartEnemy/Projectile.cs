...
public abstract class Projectile : MonoBehaviour {
    ...
    public virtual void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (takeDamage != null)
        {
            ...
            if (other.gameObject.GetComponent(typeof(Projectile)) != null)
            {
                ...
                OnCollideTakeDamageE(other, takeDamage);
            return;
        }
        else
        {
            ...
            {
                OnCollideTakeDamageBodyPartT(other, takeBodyDamage);
            }
            else
                OnCollideOther(other);
        }
	...
	protected virtual void OnCollideTakeDamageE(Collider2D other, ICanTakeDamage takedamage){}

    protected virtual void OnCollideTakeDamageBodyPartT(Collider2D other, ICanTakeDamageBodyPart takedamage) { }
