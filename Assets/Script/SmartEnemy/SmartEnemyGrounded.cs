...
public class SmartEnemyGrounded : Enemy, ICanTakeDamage {
	...
	public override void Update ()
	{
        ...
        if (enemyState != ENEMYSTATE.WALK || GameManagerZS.Instance.state != GameManagerZS.GameState.Playing)
        {
            return;
        }
    ...
    public virtual void LateUpdate(){
        ...
        Vector2 _dir = GameManagerZS.Instance.player.transform.position - transform.position;
	...
	public override void Die ()
	{
		...
		StopAllCoroutines ();
            StartCoroutine(DisableEnemy(AnimationHelperZS.GetAnimationLength(anim, "Die") + 2f));
    }
