...
public class HelicopterUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            helicopterLeft.SetActive(HellicopterFinishPoint.Instance.gameObject.transform.position.x < GameManagerZS.Instance.player.transform.position.x);
            helicopterRight.SetActive(HellicopterFinishPoint.Instance.gameObject.transform.position.x > GameManagerZS.Instance.player.transform.position.x);
        }
        else
        {
